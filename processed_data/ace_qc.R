...
# create frequency x duration score
df1$ACE1.fxd <- ( df1$ACE1.frq.4 / df1$ACE1.frq.2 )*df1$ACE1.frq.3
df1$ACE2.fxd <- ( df1$ACE2.frq.4 / df1$ACE2.frq.2 )*df1$ACE2.frq.3
df1$ACE7.fxd <- ( df1$ACE7.frq.4 / df1$ACE7.frq.2 )*df1$ACE7.frq.3
df1$ACE9.fxd <- ( df1$ACE9.frq.4 / df1$ACE9.frq.2 )*df1$ACE9.frq.3
df1$ACE10.fxd <- ( df1$ACE10.frq.4 / df1$ACE10.frq.2 )*df1$ACE10.frq.3
df1$ACE11.fxd <- ( df1$ACE11.frq.4 / df1$ACE11.frq.2 )*df1$ACE11.frq.3
df1$ACE12.fxd <- ( df1$ACE12.frq.4 / df1$ACE12.frq.2 )*df1$ACE12.frq.3
df1$ACE13.fxd <- ( df1$ACE13.frq.4 / df1$ACE13.frq.2 )*df1$ACE13.frq.3
df1$ACE14.fxd <- ( df1$ACE14.frq.4 / df1$ACE14.frq.2 )*df1$ACE14.frq.3
df1$ACE15.fxd <- ( df1$ACE15.frq.4 / df1$ACE15.frq.2 )*df1$ACE15.frq.3

# create same score, weighted by multiple daily occurrences
